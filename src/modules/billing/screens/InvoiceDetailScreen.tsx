              ...
              <Button
                ...
                onPress={() =>
                  openWhatsApp(
                    ...
                    `Hi ${invoice.client?.name || "there"}, your Rashtrafarm Ad Pali bill ${invoice.invoiceNo} for ${invoice.period} is ₹${invoice.total.toLocaleString("en-IN")}, due ${fmtDate(invoice.dueDate)}. Kindly clear it at your convenience. Thank you!`,
                  )
                }
              />
              <Button
