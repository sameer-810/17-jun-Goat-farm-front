...
function buildHtml(
  ...
  <body><div class="page">
    <div class="top">
      <div><div class="brand">Fatima Goat Farm</div><div class="doc">Digital Passport</div></div>
    ...
    <div class="foot">Generated by Fatima Goat Farm · ${fmtDate(new Date().toISOString())}</div>
  </div></body></html>`;
}
